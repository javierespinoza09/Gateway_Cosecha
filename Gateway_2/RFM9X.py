#bibliotecas que se usan para interactuar con pines.
import board
...
class RFM9X(object):
    def __init__(self, freq=915.0, power=23, node=110):
    ...
    def rec_ack(self) -> bool:
        ...
        while (time.time()-t1 < 3):
            packet = self.rfm9x.receive(with_ack=False, with_header=True, timeout=3.0, keep_listening=True)
